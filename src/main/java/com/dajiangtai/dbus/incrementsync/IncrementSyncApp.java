package com.dajiangtai.dbus.incrementsync;

import com.alibaba.otter.canal.protocol.FlatMessage;
import com.dajiangtai.chap16And17.SimpleSource;
import com.dajiangtai.dbus.canal.FlatMessageSchema;
import com.dajiangtai.dbus.function.DbusProcessFuntion;
import com.dajiangtai.dbus.model.Flow;
import com.dajiangtai.dbus.model.GlobalConfig;
import com.dajiangtai.dbus.sink.HbaseSyncService;
import com.dajiangtai.dbus.sink.HbaseSyncSink;
import com.dajiangtai.dbus.sink.HbaseTemplate;
import com.dajiangtai.dbus.source.FlowSoure;
...
public class IncrementSyncApp {
    ...
    public static void main(String[] args) throws Exception{
        ...
        //keyby：同一个库，同一个表的FlatMessage会分到同一个partition
